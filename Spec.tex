...
$i\_att\_group\_cardinality$ takes an optional cardinality and a set of quads and returns a list sctids and the groups in which they passed the cardinality constraint.  The cardinality
of each zero group is evaluated separately, but only a single entry is created in the passing list if \emph{any} of the singleton groups passes.
